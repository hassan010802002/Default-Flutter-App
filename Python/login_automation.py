...
def login_webview_automation(server_url, app_path, chromedriver_path, device_name, login_id, user_id, password, captcha_text):
    """
    ...
    try:
        ...
        for xpath, input_text in fields.items():
            insert_data(driver, xpath, input_text)
...
def insert_data(driver, xpath, input_text):
